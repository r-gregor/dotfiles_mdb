...
let g:dracula#palette.bg        = ['#131926', 236]
" let g:dracula#palette.bgdark    = ['#21222C', 235]
" let g:dracula#palette.bgdarker  = ['#191A21', 234]
let g:dracula#palette.bgdark    = ['#131926', 235]
let g:dracula#palette.bgdarker  = ['#131926', 234]
" let g:dracula#palette.bg        = ['#20222b', 234]
" let g:dracula#palette.bgdark    = ['#1a1b23', 233]
" let g:dracula#palette.bgdarker  = ['#14151a', 232]
" let g:dracula#palette.bgdarker  = ['#010414', 232]
" let g:dracula#palette.bgdarker  = ['#00020a', 232]
...
" let g:dracula#palette.color_0  = '#000000'
